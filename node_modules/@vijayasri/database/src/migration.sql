-- ====================================================================
-- VIJAYASRI FOOTWEAR - INITIAL DATABASE MIGRATION SCRIPT
-- ====================================================================
...
VALUES ('footwear-images', 'footwear-images', true)
ON CONFLICT (id) DO NOTHING;

-- Storage policies for footwear-images bucket
CREATE POLICY select_images ON storage.objects FOR SELECT TO public USING (bucket_id = 'footwear-images');
CREATE POLICY insert_images ON storage.objects FOR INSERT TO public WITH CHECK (bucket_id = 'footwear-images');
CREATE POLICY update_images ON storage.objects FOR UPDATE TO public USING (bucket_id = 'footwear-images');
CREATE POLICY delete_images ON storage.objects FOR DELETE TO public USING (bucket_id = 'footwear-images');
